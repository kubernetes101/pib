...
spec:
  ...
  url: https://github.com/kubernetes101/pib # the url that we set in `flux bootstrap git` points Flux to the specified repository
---
...
### Resetting your cluster
  ...
  # delete and create a cluster
  kic cluster create

  # delete flux files
  rm -rf deploy/bootstrap

  # update git
  git pull
  git commit -am "removed flux files"
  git push
